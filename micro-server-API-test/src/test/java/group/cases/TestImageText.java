...
public class TestImageText {	
	...
	String teacherId = "";
 	...
 	public void testImageTextAdd() throws UnsupportedEncodingException  {
 		...
 		String res = ImageTextBusiness.ImageTextAdd(baseCover,contentJson,"release",teacherId,title);
 	...
 	public void testImageTextAddExeption() throws UnsupportedEncodingException  {
 		...
 		System.out.println("2.创建图文课接口-缺少必填入参:"+"msg="+msg+","+"data="+data+","+"imagetext_id="+imagetext_id);
 	...
 	public void testImageTextAddDraft() throws UnsupportedEncodingException  {
 		...
 		String contentJsonStr = "{\"blocks\":[{\"key\":\"85lj8\",\"text\":\"text test\",\"type\":\"unstyled\","
 				+ "\"depth\":0,\"inlineStyleRanges\":[],\"entityRanges\":[],\"data\":{}}],\"entityMap\":{}}";
 		String contentJson = JSONObject.parseObject(contentJsonStr).toJSONString();
 		String res = ImageTextBusiness.ImageTextAdd(baseCover,contentJson,"draft",teacherId,title);
 	...
 	@Test(description="5.编辑图文课接口", priority=5)
 	public void testImageTextEdit() throws UnsupportedEncodingException  {
 		...
 		String contentJson = JSONObject.parseObject(contentJsonStr).toJSONString();
 		title = titletemp;
 		String res = ImageTextBusiness.ImageTextEdit(baseCover,contentJson,teacherId,title,imagetext_id);
 		String msg = (String)JSONPath.read(res, "$.msg");
 		Integer code = (Integer) JSONPath.read(res, "$.code");
 		System.out.println("5.编辑图文课接口:"+"code="+code+","+"msg="+msg);
 		Assert.assertEquals(msg, "编辑课程成功","5.编辑图文课接口：" + res);
 	}
 	...
 	public void testImageTextReleasedSharedList(){
 		String res = ImageTextBusiness.ImageTextReleasedList("","sharing","released");
 		Integer total = (Integer) JSONPath.read(res, "$.total");
 		System.out.println("7.已发布的图文课列表-只看分享中的数据接口:"+"total="+total);
 		Assert.assertNotNull(total ,"7.已发布的图文课列表-只看分享中的数据接口：" + res);
 	}
 	...
 	public void testAddConcatperson(){
 		String res = ImageTextBusiness.AddConcatperson("汶灵芝","15811111111");
 	...
 	public void testAddConcatpersonExitsName(){
 		String res = ImageTextBusiness.AddConcatperson("汶灵芝","15811111112");
 	...
 	public void testAddConcatpersonExitsPhone(){
 		String res = ImageTextBusiness.AddConcatperson("汶测试","15811111111");
 		String message = (String) JSONPath.read(res, "$.message");
 	...
 	public void testRecommendSet(){
 		...
 		Assert.assertEquals(msg, "recommend sucess" ,"14.置顶图文课：" + res);
 	}
...
// 	}
 	...
 	@Test(description="30.图文课删除接口", priority=30)
 	public void testCourseDelete(){
 		String res = ImageTextBusiness.CourseDelete(imagetext_id);
 		String msg = (String) JSONPath.read(res, "$.msg");
 		System.out.println("30.图文课删除接口:"+"msg="+msg);
 		Assert.assertEquals(msg, "删除课程成功" ,"30.图文课删除接口：" + res);
 	}
 	
 	@Test(description="31.图文课删除-存为草稿发布后再取消发布再删除接口", priority=31)
 	public void testCourseDeleteDraft(){
 		String res = ImageTextBusiness.CourseDelete(imagetext_draft_id);
 		String msg = (String) JSONPath.read(res, "$.msg");
 		System.out.println("31.图文课删除-存为草稿发布后再取消发布再删除接口:"+"msg="+msg);
 		Assert.assertEquals(msg, "删除课程成功" ,"31.图文课删除-存为草稿发布后再取消发布再删除接口：" + res);
 	}
 	
 	@Test(description="32.图文课删除-无讲师接口", priority=32)
 	public void testCourseDeleteNoTeacher(){
 		String res = ImageTextBusiness.CourseDelete(imagetext_noTeacher_id);
 		String msg = (String) JSONPath.read(res, "$.msg");
 		System.out.println("32.图文课删除-无讲师接口:"+"msg="+msg);
 		Assert.assertEquals(msg, "删除课程成功" ,"32.图文课删除-无讲师接口：" + res);
 	}
 	
 	@Test(description="33.图文课删除-图文课已被删除接口", priority=33)
 	public void testCourseDeleted(){
 		String res = ImageTextBusiness.CourseDelete(imagetext_id);
 		String message = (String) JSONPath.read(res, "$.message");
 		System.out.println("33.图文课删除-图文课已被删除接口:"+"message"+message);
 		Assert.assertEquals(message, "Course has been deleted" ,"33.图文课删除-图文课已被删除接口：" + res);
 	}
 	
 	@Test(description="34.删除联系人接口", priority=34)
 	public void testDeleteConcatPersonInfo(){
 		String res = ImageTextBusiness.DeleteConcatPersonInfo(concat_person_ids);
 		String message = (String) JSONPath.read(res, "$.message");
 		System.out.println("34.删除联系人接口:"+"message="+message);
 		Assert.assertEquals(message, "success" ,"34.删除联系人接口：" + res);
 	}
 	
 	@Test(description="35.删除联系人-添加的已存在姓名的删除接口", priority=35)
 	public void testDeleteConcatPersonInfoExitsName(){
 		...
 		String message = (String) JSONPath.read(res, "$.message");
 		System.out.println("35.删除联系人-添加的已存在姓名的删除接口:"+"message="+message);
 		Assert.assertEquals(message, "success" ,"35.删除联系人-添加的已存在姓名的删除接口：" + res);
 	}
}
