...
public class CorrectWrongRateBusiness {
    ...
    public static String result_score_url (String exam_id) {
		return exam_url + "v2/"+enterpriseId+"/exams/"+exam_id+"/result/";
	}
	...
	public static String QueryQuestionBankList(String keyword){	
	 ...
	 /**   
		...
		/**   
		 * @Title: ExamAdd  
		 * @Description: TODO  创建考试任务-漏题给分的随机试卷模式
		 * @param: @return      
		 * @return: String      
		 * @throws   
		 */ 
		public static String ExamAddbank(String beginTime,String endTime,String fillBlankCount,String fillBlankType,
				String fillBlankUnitScore,String multipleCount,String multipleUnitScore,String multipleMissedScore,
		 ...
		 * @throws   
		 */ 
		public static String SubmitExam(String exam_id,String multiplechoice_id1,String multiplechoice1_option1,String multiplechoice1_option2,
				String multiplechoice_id2,String multiplechoice2_option1,String multiplechoice2_option2,String multiplechoice2_option3,
				String multiplechoice_id3,String multiplechoice3_option1,String multiplechoice3_option2,String multiplechoice3_option3,
				String multiplechoice3_option4){	
			return HttpRequest.post(submit_exam_url(exam_id)).query("access_token", token).data("{\r\n" + 
					"      \"questions\": [\r\n" + 
					"            {\r\n" + 
					"                  \"id\": \""+multiplechoice_id1+"\",\r\n" + 
					"                  \"answer\": [\r\n" + 
					"                        \""+multiplechoice1_option1+"\",\r\n" + 
					"                        \""+multiplechoice1_option2+"\"\r\n" + 
					"                  ],\r\n" + 
					"                  \"answer_image\": \"\"\r\n" + 
					"            },\r\n" + 
					"            {\r\n" + 
					...
					"                  \"answer\": [\r\n" + 
					"                        \""+multiplechoice2_option1+"\",\r\n" + 
					"                        \""+multiplechoice2_option2+"\",\r\n" + 
					"                        \""+multiplechoice2_option3+"\"\r\n" + 
					"                  ],\r\n" + 
					"                  \"answer_image\": \"\"\r\n" + 
					"            },\r\n" + 
					"            {\r\n" + 
					...
					"                  \"answer\": [\r\n" + 
					"                        \""+multiplechoice3_option1+"\",\r\n" + 
					"                        \""+multiplechoice3_option2+"\",\r\n" + 
					"                        \""+multiplechoice3_option3+"\",\r\n" + 
					"                        \""+multiplechoice3_option4+"\"\r\n" + 
					"                  ],\r\n" + 
					"                  \"answer_image\": \"\"\r\n" + 
					"            }\r\n" + 
					"      ],\r\n" + 
		 ...
		 * @throws   
		 */ 
		public static String StudyPlanAdd(String title,String title1,String title2,String paperId,String paper_title,String questionBank_id,
				String multipleCount,String multipleUnitScore,String multipleMissedScore){			
			return HttpRequest.post(studyPlan_add_url).query("access_token", token).data("{\r\n" + 
					...
					"                              \"multipleMissedScore\": \""+multipleMissedScore+"\",\r\n" + 
					"                              \"totalScore\": \"\",\r\n" + 
					"                              \"answerParsing\": 5,\r\n" + 
					"                              \"passingScore\": 60,\r\n" + 
					"                              \"cutScreenCount\": -1,\r\n" + 
		 ...
		 * @throws   
		 */ 
		public static String StudyProjectSaveStageContent(String project_id,String title1,String paperId,String title2,
				String questionBank_id,String multiple_count,String multiple_unit_score,String multiple_missed_score) {
			return HttpRequest.post(studyProject_add_url).query("access_token", token).data("{\r\n" + 
					...
					"                                          \"multiple_missed_score\": \""+multiple_missed_score+"\",\r\n" + 
					"                                          \"total_score\": \"\",\r\n" + 
					"                                          \"answer_parsing\": 5,\r\n" + 
					"                                          \"passing_score\": 60,\r\n" + 
					"                                          \"cut_screen_count\": -1,\r\n" + 
		 ...
		 * @throws   
		 */ 
		public static String UpdateContent(String employee_train_id,String title1,String paperId,String paper_title,String title2,
				String questionBank_id,String multiple_count,String multiple_unit_score,String multiple_missed_score) {
